...
describe("Dropin", () => {
  ...
  beforeEach(() => {
    ...
    jest
      .spyOn(vaultManager, "create")
      .mockResolvedValue(testContext.vaultManager);
    ...
    jest
      .spyOn(threeDSecure, "create")
      .mockResolvedValue(fake.threeDSecureInstance);
  });
  ...
  describe("Constructor", () => {
    test("inherits from EventEmitter", () => {
      expect(new Dropin(testContext.dropinOptions)).toBeInstanceOf(
        EventEmitter
      );
    });
  });
  ...
  describe("_initialize", () => {
    ...
    test("errors out if both a selector and container are given", (done) => {
      ...
      testContext.dropinOptions.merchantConfiguration.selector = {
        value: "#bar",
      };
    ...
    test("does not error if at least one dependency is available", (done) => {
      let instance;
      const hostedFieldsError = new Error("HostedFields Error");
    ...
    test("presents payment option as disabled if it fails", (done) => {
      ...
      instance._initialize(() => {
        const paypalOption = testContext.container.querySelector(
          ".braintree-option__paypal"
        );

        expect(paypalOption.className).toMatch("braintree-disabled");
        expect(paypalOption.innerHTML).toMatch(
    ...
    test("throws an error with a container that points to a nonexistent DOM node", (done) => {
      let instance;
    ...
    test("throws an error if merchant container from options.container is not empty", (done) => {
      let instance;
    ...
    test("throws an error if merchant container from options.container is not empty", (done) => {
      ...
      testContext.dropinOptions.merchantConfiguration.container =
    ...
    test("throws an error if merchant container from options.container is not a domNode-like object", (done) => {
      let instance;
    ...
    test("inserts dropin into container if merchant container has white space", (done) => {
      let instance;
      ...
      instance._initialize(() => {
        expect(testContext.container.innerHTML).toMatch(
          'class="braintree-dropin'
        );
    ...
    test("injects stylesheet into shadow DOM instead of the head", (done) => {
      ...
      instance._initialize(() => {
        const stylesheet = shadowDom.querySelector(
          `#${constants.STYLESHEET_ID}`
        );
    ...
    test("does not inject stylesheet if it already exists on the page", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("requests payment methods if a customerId is provided", (done) => {
      ...
      instance._initialize(() => {
        try {
          ...
          expect(testContext.vaultManager.fetchPaymentMethods).toBeCalledTimes(
            1
          );
    ...
    test("does not fail if there is an error getting existing payment methods", (done) => {
      let instance;
    ...
    test("calls the create callback when async dependencies are ready", (done) => {
      const instance = new Dropin(testContext.dropinOptions);

      jest
        .spyOn(DropinModel.prototype, "asyncDependencyStarting")
        .mockImplementation();
      jest
        .spyOn(DropinModel.prototype, "asyncDependencyReady")
        .mockImplementation();
    ...
    test("adds payment method if app switch payload exists", (done) => {
      ...
      jest
        ...
        .mockImplementation();
      jest
        .spyOn(DropinModel.prototype, "addPaymentMethod")
        .mockImplementation();
    ...
    test("sends web.dropin.appeared event when async dependencies are ready", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("sends vaulted payment method appeared events for each vaulted payment method", (done) => {
      const instance = new Dropin(testContext.dropinOptions);

      jest
        .spyOn(DropinModel.prototype, "getVaultedPaymentMethods")
        .mockResolvedValue([
      ...
      instance._initialize(() => {
        ...
        expect(analytics.sendEvent).toBeCalledWith(
          instance._client,
          "vaulted-paypal.appear"
        );
        done();
      });
    });

    test("sends a single analytic event even when multiple vaulted payment methods of the same kind are available", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("does not send payment method analytic event when app switch payload present", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("does not send payment method analytic event when app switch error present", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("does not send web.vaulted-card.appear analytic event when no vaulted cards appear", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("loads localized strings into mainView when options.locale is specified", (done) => {
      let instance;
      ...
      instance._initialize(() => {
        expect(instance._mainView.strings.postalCodeLabel).toBe(
          "Código postal"
        );
        done();
      });
    ...
    test("uses custom translations when options.translations is specified", (done) => {
      let instance;
      ...
      instance._initialize(() => {
        expect(instance._mainView.strings.payingWith).toBe(
          "You are paying with {{paymentSource}}"
        );
        expect(instance._mainView.strings.chooseAnotherWayToPay).toBe(
          "My custom chooseAnotherWayToPay string"
        );
        expect(instance._mainView.strings.postalCodeLabel).toBe("Postal Code");
        done();
      });
    ...
    test("loads localized strings into mainView when options.locale is a supported locale ID", (done) => {
      let instance;
    ...
    test("loads supported localized strings into mainView when options.locale is a locale ID with an unsupported country", (done) => {
      let instance;
    ...
    test("loads default strings into mainView when options.locale is unknown", (done) => {
      let instance;
  ...
  describe("loads data collector", () => {
    beforeEach(() => {
      testContext.dropinOptions.merchantConfiguration.dataCollector = {
        kount: true,
      };
  ...
  describe("_setUpDataCollector", () => {
    ...
    test("fails initialization when Data Collection creation fails", (done) => {
  ...
  describe("teardown", () => {
    ...
    test("removes dropin node from page", (done) => {
      testContext.instance.teardown(() => {
        expect(
          testContext.container.contains(testContext.instance._dropinWrapper)
        ).toBe(false);
        done();
      });
    });
    ...
    test("passes errors from data collector teardown to callback", (done) => {
      ...
      testContext.instance.teardown((err) => {
        expect(err.message).toBe(
          "Drop-in errored tearing down Data Collector."
        );
        done();
      });
    });
  ...
  describe("requestPaymentMethod", () => {
    test("calls the requestPaymentMethod function of the MainView", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("returns a formatted payload", (done) => {
      ...
      instance._initialize(() => {
        jest
          .spyOn(instance._mainView, "requestPaymentMethod")
    ...
    test("includes rawPaymentData if a Google Pay payment method", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("includes rawPaymentData if an Apple Pay payment method", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
      const rawPaymentData = { foo: "bar" };
      const fakePayload = {
        nonce: "cool-nonce",
    ...
    test("does not call 3D Secure if payment method does not support 3DS", (done) => {
      let instance;
      const fakePayload = {
        nonce: "cool-nonce",
        type: "PAYPAL_ACCOUNT",
    ...
    test("does not call 3D Secure if payment method nonce payload contains liablity information", (done) => {
      let instance;
      const fakePayload = {
        nonce: "cool-nonce",
        type: "CreditCard",
    ...
    test("calls 3D Secure if payment method nonce payload is a credit card and does not contain liability info", (done) => {
      let instance;
      const fakePayload = {
        nonce: "cool-nonce",
        type: "CreditCard",
      ...
      instance._initialize(() => {
        ...
        instance.requestPaymentMethod(() => {
          ...
          expect(instance._threeDSecure.verify).toBeCalledWith(
            fakePayload,
            undefined
    ...
    test("calls 3D Secure if payment method nonce payload is a non-network tokenized google pay and does not contain liability info", (done) => {
      let instance;
      const fakePayload = {
        nonce: "cool-nonce",
        type: "AndroidPayCard",
    ...
    test("does not call 3D Secure if network tokenized google pay", (done) => {
      let instance;
      const fakePayload = {
        nonce: "cool-nonce",
        type: "AndroidPayCard",
    ...
    test("replaces payload nonce with new 3ds nonce", (done) => {
      ...
      instance._initialize(() => {
        ...
        instance.requestPaymentMethod((err, payload) => {
          ...
          expect(payload.liabilityShifted).toBe(true);
          expect(payload.liabilityShiftPossible).toBe(true);
          expect(payload.threeDSecureInfo.threeDSecureAuthenticationId).toBe(
            "id"
          );
  ...
  describe("updateConfiguration", () => {
    ...
    test("updates if view is googlePay", () => {
      ...
      expect(fakeGooglePayView.updateConfiguration).toBeCalledWith(
        "foo",
        "bar"
      );
    });
    ...
    test("updates if property is threeDSecure", () => {
      ...
      expect(instance._threeDSecure.updateConfiguration).toBeCalledWith(
        "amount",
        "15.00"
      );
      expect(instance._mainView.getView).not.toBeCalled();
    ...
    test("does not update if property is threeDSecure, but there is no threeDSecure instance", () => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("removes saved paypal payment methods if they are not vaulted", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
      ...
      expect(instance._model.removePaymentMethod).toBeCalledWith({
        nonce: "3",
        type: "PayPalAccount",
      });
      expect(instance._model.removePaymentMethod).toBeCalledWith({
    ...
    test("does not call removePaymentMethod if no non-vaulted paypal accounts are avaialble", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
    ...
    test("removes saved applePay payment methods if they are not vaulted", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakeApplePayView = {
        updateConfiguration: jest.fn(),
    ...
    test("does not call removePaymentMethod if no non-vaulted applePay accounts are avaialble", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakeApplePayView = {
        updateConfiguration: jest.fn(),
    ...
    test("removes saved googlePay payment methods if they are not vaulted", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakeGooglePayView = {
        updateConfiguration: jest.fn(),
    ...
    test("does not call removePaymentMethod if no non-vaulted googlePay accounts are avaialble", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakeGooglePayView = {
        updateConfiguration: jest.fn(),
    ...
    test("sets primary view to options if on the methods view and there are no saved payment methods and supportedPaymentOptions is greater than 1", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
    ...
    test("sets primary view to available payment option view if on the methods view and there are not saved payment methods and only one payment option is available", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
    ...
    test("does not set primary view if current primary view is not methods", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
    ...
    test("does not set primary view if there are saved payment methods", () => {
      const instance = new Dropin(testContext.dropinOptions);
      const getViewStub = jest.fn();
      const fakePayPalView = {
        updateConfiguration: jest.fn(),
      ...
      instance._model = {
        getPaymentMethods: jest
          .fn()
          .mockReturnValue([{ nonce: "1", type: "CreditCard" }]),
        removePaymentMethod: jest.fn(),
      };
  ...
  describe("payment method requestable events", () => {
    test("emits paymentMethodRequestable event when the model emits paymentMethodRequestable", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
    ...
    test("emits noPaymentMethodRequestable events when the model emits noPaymentMethodRequestable", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
  ...
  describe("payment option selected event", () => {
    test("emits paymentOptionSelected when the model emits paymentOptionSelected", (done) => {
      const instance = new Dropin(testContext.dropinOptions);
      ...
      instance._initialize(() => {
        instance._model._emit("paymentOptionSelected", {
          paymentOption: "Foo",
        });
      });
    });
